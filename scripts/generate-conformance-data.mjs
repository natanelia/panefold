...
const sourceDefinitions = [
  ...
  [
    "panel-drop-zones",
    "automated-test",
    "packages/geometry/test/hit-test.test.ts",
    ["EXP-002", "INT-005"],
    [compactProfile],
  ],
  [
  ...
  [
    "direct-placement-durability-decision",
    "architecture-decision",
    "docs/adr/0013-direct-placement-durable-demo.md",
    ["EXP-002", "GOV-004", "INT-005", "PER-007"],
    [compactProfile],
  ],
  [
...
const resultDefinitions = [
  ...
  [
    ...
    "compatibility-report",
    "conformance/results/chromium-reference-2026-09-17.json",
    [
      "A11Y-002",
      "A11Y-003",
      "EXP-003",
  ...
  [
    ...
    "performance-report",
    "conformance/results/interaction-performance-2026-09-17.json",
  ...
  [
    ...
    "model-report",
    "conformance/results/protocol-motion-2026-09-17.json",
    [
      "A11Y-002",
      "ARC-002",
      "EXP-003",
