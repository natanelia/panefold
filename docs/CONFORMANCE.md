...
- The compact Chromium fixture covers semantics/axe, center docking, four-way container creation,
  ...
  overflow autoscroll, whole multi-tab panel-container edge movement with exact preview and one-step
...
- The Linux Chromium interaction capture records raw frame deltas, long tasks, and paired Node smoke measurements in `conformance/results/interaction-performance-2026-09-17.json`. These are experimental regression guards, not physical performance certification.
