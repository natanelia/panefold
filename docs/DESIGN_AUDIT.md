...
| `move-group`                 | Pointer edge drop, keyboard group-chrome dialog, programmatic drop plan          | Whole-container placement retains group identity and all ordered tabs; no menu or palette route is claimed. |
| `swap-groups`                | Pointer center drop, keyboard group-chrome dialog, programmatic drop plan        | Center placement swaps intact containers; no menu or palette route is claimed.                              |
